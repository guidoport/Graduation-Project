...
ds = pd.read_csv('C:/Users/s143873/Desktop/Segmented point cloud/11+12/beam.csv', delimiter=';')
ds.columns = ['x', 'y', 'z']
ts = pd.read_csv('C:/Users/s143873/Desktop/Segmented point cloud/11+12/beam.csv', delimiter=';')
...
final_output.to_csv('C:/Users/s143873/Desktop/Segmented point cloud/11+12/include_normals/beam.csv')
