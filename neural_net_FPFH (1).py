...
# print(fpfh_norm.shape)
# print(normals_curv.shape)
# print(spatial_xyz)
...
# fit
tbCallBack = TensorBoard(log_dir='./logs/val_split', histogram_freq=0, write_graph=True, write_images=True)
history = model.fit(X, Y, validation_split=.25, epochs=30, batch_size=10000, verbose=2, class_weight=class_weight, callbacks=[tbCallBack])
# model.fit(X, Y, validation_split=.33, epochs=50, batch_size=10000, verbose=2, class_weight=class_weight)

# model.save('neural_net_early_stopping.h5')
quit()
